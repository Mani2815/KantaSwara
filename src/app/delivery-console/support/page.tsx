...
export const metadata = {
  title: 'Support — Delivery Console',
};
...
export default function SupportPage() {
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-8 pb-12">
      ...
      {/* Internal Engineering Support Section */}
      <div className="mt-12 bg-[var(--color-bg-surface)] border border-[var(--color-border-default)] rounded-2xl p-8 shadow-sm flex flex-col sm:flex-row items-center gap-6">
        ...
        <div className="flex-grow text-center sm:text-left">
          <h3 className="text-xl font-bold text-[var(--color-text-primary)]">Platform Engineering Hotline</h3>
          <p className="text-[var(--color-text-secondary)] mt-1">
            Escalate P1 infrastructure issues directly to the core engineering team.
          </p>
        </div>
        <div>
