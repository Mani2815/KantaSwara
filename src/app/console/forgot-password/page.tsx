  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6">
      <div className="bg-neutral-800 p-8 rounded-xl max-w-md w-full border border-neutral-700">
        <h2 className="text-2xl font-bold text-white mb-6">Reset Internal Password</h2>
        <form className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-neutral-400 mb-1">Company Email</label>
            <input type="email" className="w-full bg-neutral-900 border border-neutral-700 rounded-lg px-4 py-2 text-white" />
          </div>
