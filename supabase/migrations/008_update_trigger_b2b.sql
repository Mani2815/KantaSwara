-- =============================================================================
-- KantaSwara — Update Profile Auto-Creation Trigger for B2B Statuses
-- Migration: 008_update_trigger_b2b.sql
-- =============================================================================
...
BEGIN
  ...
  IF NEW.email = 'smartcitycms@gmail.com' THEN
    ...
    -- If it doesn't exist, create it as active and approved
  ...
  INSERT INTO public.organizations (name, slug, is_active, status, approval_status)
  VALUES (org_name, org_slug, false, 'pending_approval', 'pending')
  RETURNING id INTO org_id;
